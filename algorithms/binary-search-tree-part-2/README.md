# Data structures. Binary Search Tree in JavaScript (part-2)
...
1. Create the variable `nodeList`, the values node are stored here
...
For this binary search tree, this method should return such an array `[6, 12, 11, 8, 16, 29, 24, 55, 42, 37, 13]`.
...
```js
tree.inOrder(); // [6, 12, 11, 8, 16, 29, 24, 55, 42, 37, 13]
```
...
For this binary search tree, this method should return such an array `[13, 8, 6, 11, 12, 37, 24, 16, 29, 42, 55]`.
...
```js
tree.inOrder(); // [13, 8, 6, 11, 12, 37, 24, 16, 29, 42, 55]
```
...
1. If root property is empty then return `null`
1. Create the variable `current`, the current node is stored here
